...
public class HouseScene extends ZeldaScene {
    ...
    public HouseScene(Game game, String entrance) {
        ...
        Polygon house = new Polygon(hxpos, hypos, hypos.length);

        int[] rxpos = {449, 450, 385, 384, 418, 416, 492, 511, 510};
        int[] rypos = {0, 27, 90, 180, 215, 292, 370, 373, 1};

        Polygon right = new Polygon(rxpos, rypos, rypos.length);
        ...
        Polygon houseCliff = new Polygon(hcxpos, hcypos, hcypos.length);

        int[] scxpos = {0, 47, 56, 56, 63, 64, 68, 69, 66, 49, 0, 0};
        int[] scypos = {383, 382, 378, 369, 362, 353, 348, 330, 328, 342, 342, 382};

        Polygon smallCliff = new Polygon(scxpos, scypos, scypos.length);
        ...
        Polygon down = new Polygon(dxpos, dypos, dypos.length);
        ...
        Polygon trees = new Polygon(txpos, typos, typos.length);
