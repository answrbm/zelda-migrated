...
public class CastleBasementScene extends ZeldaScene {
    ...
    public CastleBasementScene(Game game, String entrance) {
        ...
        Polygon wall1 = new Polygon(wxpos1, wypos1, wypos1.length);
        ...
        Polygon wall2 = new Polygon(wxpos2, wypos2, wypos2.length);
        ...
        Polygon wall3 = new Polygon(wxpos3, wypos3, wypos3.length);

        int[] wxpos4 = {868, 399, 399, 179, 177, 98, 98};
        int[] wypos4 = {930, 934, 808, 801, 790, 790, 934};

        Polygon wall4 = new Polygon(wxpos4, wypos4, wypos4.length);

        int[] wxpos5 = {437, 264, 264, 248, 248, 153, };
        int[] wypos5 = {678, 678, 748, 748, 680, 678, };

        Polygon wall5 = new Polygon(wxpos5, wypos5, wypos5.length);
        ...
        Polygon block1 = new Polygon(bxpos, bypos, bypos.length);

        int[] wxpos6 = {97, 97, 73, 73, 114, 111, 145, 33};
        int[] wypos6 = {789, 439, 439, 375, 375, 119, 113, 113};

        Polygon wall6 = new Polygon(wxpos6, wypos6, wypos6.length);

        int[] bxpos2 = {216, 201, 201, 216};
        int[] bypos2 = {757, 757, 687, 687};

        Polygon block2 = new Polygon(bxpos2, bypos2, bypos2.length);

        int[] bxpos3 = {166, 154, 154, 166};
        int[] bypos3 = {780, 780, 737, 737};

        Polygon block3 = new Polygon(bxpos3, bypos3, bypos3.length);
        ...
        Polygon wall7 = new Polygon(wxpos7, wypos7, wypos7.length);
