...
public class HyruleScene extends ZeldaScene {
    ...
    public HyruleScene(Game game, String entrance) {
        ...
        Polygon tree = new Polygon(dxpos, dypos, dypos.length);
        ...
        Polygon tree2 = new Polygon(nxpos, nypos, nypos.length);
        ...
        Polygon castleWall2 = new Polygon(cxpos, cypos, cypos.length);
        ...
        Polygon castleWall3 = new Polygon(fxpos, fypos, fypos.length);
        ...
        Polygon castleWall1 = new Polygon(expos, eypos, eypos.length);
        ...
        Polygon wall = new Polygon(gxpos, gypos, gypos.length);


        int[] ixpos = {34, 92, 117, 44, 35,};
        int[] iypos = {932, 950, 1006, 1000, 932,};

        Polygon downWall = new Polygon(ixpos, iypos, iypos.length);

        int[] zxpos = {181, 210, 211, 638, 668, 180};
        int[] zypos = {1004, 992, 956, 953, 1010, 1008};

        Polygon downWall1 = new Polygon(zxpos, zypos, zypos.length);
        ...
        Polygon bush1 = new Polygon(jxpos, jypos, jypos.length);
        ...
        Polygon bush2 = new Polygon(kxpos, kypos, kypos.length);
        ...
        Polygon bush3 = new Polygon(mxpos, mypos, mypos.length);
        ...
        Polygon balk = new Polygon(oxpos, oypos, oypos.length);
        ...
        Polygon garden = new Polygon(pxpos, pypos, pypos.length);
        ...
        Polygon garden1 = new Polygon(qxpos, qypos, qypos.length);
        ...
        Polygon garden3 = new Polygon(rxpos, rypos, rypos.length);
        ...
        Polygon wall1 = new Polygon(xpos, ypos, ypos.length);
