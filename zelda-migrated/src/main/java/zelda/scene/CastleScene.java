...
public class CastleScene extends ZeldaScene {
    ...
    public CastleScene(Game game, String entrance) {
        ...
        Polygon stukMuur2 = new Polygon(cxpos, cypos, cypos.length);
        ...
        Polygon rechtSonder = new Polygon(dxpos, dypos, dypos.length);
        ...
        Polygon rechts = new Polygon(expos, eypos, eypos.length);
        ...
        Polygon rechtsMidden = new Polygon(fxpos, fypos, fypos.length);
        ...
        Polygon linkSonder = new Polygon(gxpos, gypos, gypos.length);
